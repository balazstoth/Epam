...
namespace Max2Test
{
    ...
    public class Max2Test
    {
        ...
        {
            var a = new[] { 1, 2, 3, 4, 5 };
            Assert.AreEqual(4, a.Max2(), "Second max value should be 4");
        }
        ...
        {
            var a = new[] { 10, 10, 5 };
            Assert.AreEqual(5, a.Max2(), "Second max value should be 5");
        }
        ...
        public void RandomValues()
        {
            ...
            Assert.AreEqual(8, a.Max2(), "Second max value should be 8");
        }
        ...
        public void MinusValues()
        {
            ...
            Assert.AreEqual(-100, a.Max2(), "Second max value should be -100");
        }
